...
> **All project images are organized in the `/images` folder. Reference any image as:**
> ```
> ![Description](images/img_X.jpg)
> ```

```
images/
├── img_1.jpg   — Hero Banner / Product Hero Shot
├── img_2.jpg   — Login Screen (Patient)
├── img_3.jpg   — Login Screen (Doctor)
├── img_4.jpg   — Sign Up / Registration Screen
├── img_5.jpg   — Splash Screen Animation
├── img_6.jpg   — Patient Dashboard (Initial State)
├── img_7.jpg   — Patient Details Form (Name, Age, Gender)
├── img_8.jpg   — Monitoring Step 1 — System Initialization
├── img_9.jpg   — Monitoring Step 2 — Skin Temperature Measurement
├── img_10.jpg  — Monitoring Step 3 — Auscultation Recording (10s)
├── img_11.jpg  — Monitoring Step 4 — HR & SpO₂ Measurement
├── img_12.jpg  — Monitoring Step 5 — Final AI Analysis Processing
├── img_13.jpg  — Clinical Report — Normal Result (Heart + Lung)
├── img_14.jpg  — Clinical Report — Abnormal / Alert Result
├── img_15.jpg  — Clinical Report — Artifact Warning + Retry Prompt
├── img_16.jpg  — Doctor Dashboard — Active Consultations List
├── img_17.jpg  — Doctor Consultation — Live Video Call Interface
├── img_18.jpg  — Doctor Prescription Modal — Writing Prescription
├── img_19.jpg  — Digital Prescription PDF Preview
├── img_20.jpg  — Admin Dashboard — Overview Tab (Charts & Stats)
├── img_21.jpg  — Admin Dashboard — Sessions Tab (All Sessions)
├── img_22.jpg  — Admin Dashboard — Doctors Management Tab
├── img_23.jpg  — Admin Dashboard — Analytics Tab
├── img_24.jpg  — Final Hardware Model (Front View)
├── img_25.jpg  — Final Hardware Model (Side View with OLED Display)
├── img_26.jpg  — Final Hardware Model (Enclosure Open — Internals)
├── img_27.jpg  — Hardware Close-up — ESP32-S3 Board
├── img_28.jpg  — Hardware Close-up — INMP441 I2S Microphone + Acoustic Cup
├── img_29.jpg  — Hardware Close-up — MAX30105 PPG Sensor
├── img_30.jpg  — Hardware Close-up — MAX30205 Temperature Sensor
├── img_31.jpg  — Hardware Close-up — SH1106 OLED Display (Live Vitals)
├── img_32.jpg  — Hardware Close-up — HC12 RF Module (Offline Mode)
├── img_33.jpg  — Hardware Close-up — RGB LED Status Indicators
├── img_34.jpg  — Full Hardware Kit (All Components Laid Out)
├── img_35.jpg  — Circuit Diagram / Schematic (ESP32-S3 Connections)
├── img_36.jpg  — System Architecture Diagram (Hardware ↔ Cloud ↔ AI)
├── img_37.jpg  — Data Flow Diagram — Patient Session Flow
├── img_38.jpg  — AI Inference Pipeline Diagram (Audio → Features → Model)
├── img_39.jpg  — HC12 Offline Fail-Safe Architecture Diagram
├── img_40.jpg  — Real-World Usage Photo — Device on Patient Chest
├── img_41.jpg  — Real-World Usage Photo — Health Worker Operating Device
├── img_42.jpg  — Real-World Usage Photo — Doctor on Video Consultation
├── img_43.jpg  — OLED Display Close-up — "Recording Auscultation..."
├── img_44.jpg  — OLED Display Close-up — "HR: 72 | SpO₂: 98% | Temp: 36.8°C"
├── img_45.jpg  — OLED Display Close-up — "OFFLINE MODE — HC12 ACTIVE"
├── img_46.jpg  — OLED Display Close-up — Traffic Light LED Status (Green)
├── img_47.jpg  — OLED Display Close-up — Traffic Light LED Status (Red)
├── img_48.jpg  — Team Photo / Project Booth / Demo Setup
├── img_49.jpg  — AURANet Training Curves (Loss + AUC per Epoch)
├── img_50.jpg  — LungNet Confusion Matrix (Normal/Crackle/Wheeze)
```
