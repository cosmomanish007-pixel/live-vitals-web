...
const Report = () => {
  ...
  const getRiskTextColor = () => {
    if (clinical.riskLevel === 'HIGH') return 'text-red-500';
    if (clinical.riskLevel === 'MODERATE') return 'text-yellow-500';
  ...
  const isAbnormal = (field: string) =>
    clinical.abnormalFields.includes(field);
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-6">
      <div className="mx-auto max-w-md space-y-6">
        ...
        {/* RISK CARD */}
        <Card className={`bg-gradient-to-r ${riskGradient} text-white shadow-xl`}>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            const abnormal = isAbnormal(v.label);
            ...
            return (
              <Card
                ...
                className={`transition-all duration-300 ${
                  abnormal ? 'border-red-500 border-2 shadow-red-500/30 shadow-md' : ''
                }`}
              >
